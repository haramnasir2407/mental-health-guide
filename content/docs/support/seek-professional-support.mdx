...
<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
  <h2 className="text-xl md:text-2xl font-satoshi m-0" style={{ fontWeight: 500, textDecoration: 'none' }}>Find the Best Doctor Near You</h2>
  <Link
    href="#"
    className="h-12 group inline-flex items-center justify-center gap-2 px-6 rounded-lg text-white font-satoshi text-base transition-all hover:opacity-90 font-light"
    style={{
      background: "#9254DE",
    }}
  >
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="relative bg-[#F5F5F5]">
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center p-8">
      ...
      <h3 className="font-satoshi text-lg" style={{ fontWeight: 500 }}>Video Consultancy</h3>
    </div>
  </div>
  ...
  <div className="relative bg-[#F5F5F5]">
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center p-8">
      ...
      <h3 className="font-satoshi text-lg" style={{ fontWeight: 500 }}>In-Person Consultancy</h3>
    </div>
  </div>
</div>
