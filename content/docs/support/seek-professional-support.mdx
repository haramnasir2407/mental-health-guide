...
<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
  ...
  <Link
    ...
    className="h-12 group inline-flex items-center justify-center gap-2 px-6 rounded-md text-white font-satoshi text-base transition-all hover:opacity-90 font-light no-underline"
    style={{
      background: "#9254DE",
    }}
  >
