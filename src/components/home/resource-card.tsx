...
export const ResourceCard: React.FC<ResourceCardProps> = ({
  ...
  return (
    <div className="relative w-full max-w-[1312px] h-[421px] border border-[#1A1A1A] bg-white">
      <div className="grid grid-cols-[355px_1fr] h-full">
        ...
        <div className="grid grid-cols-[1fr_187px] h-full">
          ...
          <div className="flex flex-col justify-center px-12 py-8 border-r border-[#1A1A1A]">
            ...
            <p className="text-xs lg:text-sm text-[#001100]/70  w-full">
              {description}
            </p>
          </div>
          ...
          <div className="grid grid-rows-[183px_auto_1fr]">
            ...
            <div className="grid grid-cols-2">
              {/* Arrow Section */}
              <div
                className="border-r border-[#1A1A1A] flex items-center justify-center cursor-pointer hover:bg-[#EAEAE0] transition-colors"
              ...
              {/* Empty Box */}
              <div className="flex items-center justify-center bg-[#F5F5F0]" />
            </div>
          </div>
        </div>
      </div>
